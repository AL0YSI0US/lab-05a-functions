...
function sumAndMultiply(a,b,c) { //eslint-disable-line
  let sumLocal = sum(sum(a,b)[0], c)[0];
  let multiplyLocal = multiply(multiply(a,b)[0], c)[0];
  let messagOne = `${a} and ${b} and ${c} sum to ${sumLocal}.`;
  let messageTwo = `The product of ${a} and ${b} and ${c} is ${multiplyLocal}.`;
  return [sumLocal, multiplyLocal, messagOne, messageTwo];
}
